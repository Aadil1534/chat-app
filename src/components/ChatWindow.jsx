...
export default function ChatWindow({
  ...
  if (!chatId || !selectedChat) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center bg-[#f8f9fa] text-gray-500">
                ...
                <div key={msg.id}>
                  {showDate && (
                    <div className="flex justify-center my-4">
                      <span className="px-4 py-1 bg-gray-200/80 rounded-full text-xs text-gray-600">
                        {msgDate}
                      </span>
                    </div>
                  )}
      ...
      <div className="p-4 border-t border-gray-200 bg-white flex-shrink-0">
        <form onSubmit={handleSend} className="flex items-center gap-2">
          ...
          <input
            ...
            className="flex-1 px-4 py-2.5 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#6C3EF4]/30 focus:border-[#6C3EF4]"
          />
          <button
            type="button"
